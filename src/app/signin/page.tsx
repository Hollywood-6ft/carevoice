    ...
    <div className="flex min-h-screen bg-gradient-to-br from-white to-gray-50">
      <div className="w-full max-w-md mx-auto flex items-center justify-center p-8">
        <div className="w-full space-y-8 text-center">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2 whitespace-nowrap">
              CareVoice Assistant
            </h1>
          ...
          <div className="mt-8">
            ...
            <button 
              ...
              disabled={loading}
              className={`w-full h-12 flex items-center justify-center ${loading ? 'bg-gray-100' : 'bg-white hover:bg-gray-50'} border border-gray-300 rounded-full transition-colors`}
            >
              {loading ? (
                ...
                <>
                  ...
                  <span className="text-[15px] text-gray-900 font-medium">Sign in with Google</span>
                </>
              )}
            </button>
            ...
            <p className="text-xs text-gray-500 text-center mt-4">
              ...
              <a href="#" className="text-orange-500 hover:text-orange-600">Privacy Policy</a>, including cookie use.
            </p>
          </div>
        </div>
      </div>
